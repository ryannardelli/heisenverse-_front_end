            ...
            <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <span className="text-gray-400 text-xs">Temporada 5, Ep. 14</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <span className="text-gray-400 text-xs">Temporada 4, Ep. 13</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <span className="text-gray-400 text-xs">Temporada 3, Ep. 10</span>
                </div>
              </div>
            </div>
          </div>
