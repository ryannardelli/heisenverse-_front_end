        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-emerald-600 text-white rounded-lg shadow-lg p-8 text-center">
            <h3 className="text-xl font-semibold mb-4">
              Responda a perguntas sobre a série e descubra o quanto você realmente conhece Breaking Bad!
            </h3>
            <p className="text-lg mb-8">
              Será que você lembra dos detalhes sobre os eventos mais importantes? Quem é o verdadeiro mestre da química? 
              Teste seus conhecimentos sobre a trama, personagens e momentos icônicos!
            </p>
